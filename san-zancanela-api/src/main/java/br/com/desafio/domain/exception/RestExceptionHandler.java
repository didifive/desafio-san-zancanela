...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler( { SanZancanelaApiException.class, RuntimeException.class } )
    public ResponseEntity<ApiErrorDto> handlePeopleHubException(SanZancanelaApiException e, HttpServletRequest request){

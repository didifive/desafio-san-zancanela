...
class PaymentControllerTest {
    ...
    void testConfirmPayment() throws Exception {
        PaymentItemRequestDto requestItem = new PaymentItemRequestDto("charge-1", BigDecimal.valueOf(10));
        PaymentRequestDto request = new PaymentRequestDto("client-123", List.of(requestItem));

        PaymentItemModel paymentItemModel = new PaymentItemModel(requestItem.chargeId(), requestItem.paymentValue(), PaymentStatus.TOTAL);
        ...
        mockMvc.perform(put(PATH)
                ...
                .andExpectAll(
                        ...
                        , jsonPath("$.payment_items.[0].charge_id", is(paymentModel.paymentItems().get(0).chargeId()))
